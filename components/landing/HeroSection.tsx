...
const HeroSection = () => {
  return (
    <main className="flex flex-col justify-around sm:justify-start items-center text-center h-screen bg-hero-bg bg-no-repeat bg-center bg-cover overflow-hidden font-DM x-3">
